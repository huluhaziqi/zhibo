...
public class StatTest {
    ...
    public int getCurRobotCount() {
        return curRobotCount;
    }

    public void setCurRobotCount(int curRobotCount) {
        this.curRobotCount = curRobotCount;
    }
}
