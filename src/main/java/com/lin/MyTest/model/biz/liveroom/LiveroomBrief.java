...
public class LiveroomBrief {
	...
	public LiveroomBrief(LiveroomEntity liveroomEntity) {
		BeanUtils.copyProperties(liveroomEntity, this);
	}

	public LiveroomBrief(LiveroomInfo liveroomInfo) {
		BeanUtils.copyProperties(liveroomInfo, this);
	}
